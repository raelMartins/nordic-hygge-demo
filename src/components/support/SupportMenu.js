...
import {Center, Image, Modal, ModalContent, ModalOverlay, useToast} from '@chakra-ui/react';
...
import supportIcon from '/src/images/icons/support-icon.svg';
import supportCloseIcon from '/src/images/icons/support-cancel.svg';
...
const SupportMenu = ({isOpen, onClose, onOpen, isAgent = false}) => {
  ...
  const {sessionData} = useGetSession(['loggedIn', 'a_details']);
